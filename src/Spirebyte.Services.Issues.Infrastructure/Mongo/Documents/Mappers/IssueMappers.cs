...
internal static class IssueMappers
{
    ...
    {
        return new Issue(document.Id, document.Type, document.Status, document.Title, document.Description,
            document.StoryPoints, document.ProjectId, document.EpicId, document.SprintId, document.Assignees,
            document.LinkedIssues, document.CreatedAt);
    }
